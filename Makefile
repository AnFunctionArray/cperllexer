CC=clang-11
CXX=clang++-11
CFLAGS=-I$(HOME)/localperl/lib/5.32.1/x86_64-linux/CORE -g -O0 -I/usr/include/llvm-11 -I/usr/include/llvm-c-11
CXXFLAGS=$(CFLAGS) -std=c++20  -I/usr/include/llvm-11 -I$(HOME)/vcpkg/packages/range-v3_x64-linux/include
LDFLAGS=-l:libpcre2-8.a $(shell llvm-config-11 --libs --ldflags) -L$(HOME)/localperl/lib/5.32.1/x86_64-linux/CORE -lperl -lm -lcrypt -lpthread
