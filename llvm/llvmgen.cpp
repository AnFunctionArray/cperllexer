...
struct bindings_parsing {
	virtual int escape_1(),
		text_2(),
		unused_3() = 0,
		start_str_4(),
		num_lit_5(),
		...
		unused_36() = 0,
		unused_37() = 0,
		identifier_typedef_38(),
		identifier_decl_39(),
		start_constant_expr_40(),
		end_decl_sub_41(),
		end_full_decl_42(),
		extend_decl_43(),
		start_new_scope_44(),
		...
		begin_param_list_47(),
		end_param_list_48(),
		add_type_or_qualifier_49(),
		unused_50() = 0,
		add_literal_51(),
		finish_return_statement_52(),
		finish_statement_53(),
		subscript_op_54(),
		decl_begin_55(),
		end_of_sizeof_56(),
		end_of_sizeof_tp_nm_57(),
		ident_struc_58(),
		struc_or_union_body_59(),
		struc_or_union_body_end_60(),
		perform_explicit_conversion_61(),
		create_label_62(),
		goto_stmt_63(),
		switch_stmt_64(),
		create_case_65(),
		switch_stmt_end_66(),
		create_default_case_67(),
		collect_float_literal_68(),
		finish_float_literal_69(),
		begin_if_stm_70(),
		cnt_if_stm_71(),
		finish_if_stm_72(),
		begin_loop_73(),
		...
		begin_do_while_77(),
		finish_do_while_78(),
		finish_continue_stm_79(),
		finish_break_stm_80();
};

struct bindings_compiling : bindings_parsing {
